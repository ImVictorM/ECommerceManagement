...
{
    /// <summary>
    /// A concrete implementation of <see cref="CompositeSpecification{T}"/>
    /// for testing.
    /// </summary>
    public class TestCompositeSpecification<T>
        : CompositeSpecification<T> where T : class
    {
        private readonly Func<T, bool> _predicate;

        /// <summary>
        /// Initializes a new instance of the
        /// <see cref="TestCompositeSpecification{T}"/> class.
        /// </summary>
    ...
    /// <returns>
    /// A new instance of the <see cref="CompositeSpecification{T}"/> class.
    /// </returns>
    public static CompositeSpecification<T> CreateCompositeSpecification<T>(
