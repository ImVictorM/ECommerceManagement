...
/// <summary>
/// Utilities for creating test query specifications.
/// </summary>
public static class SpecificationQueryUtils
{
    ...
    /// <param name="expression">The expression to evaluate for the specification.</param>
    /// <returns>An implementation of <see cref="ISpecificationQuery{T}"/>.</returns>
    public static ISpecificationQuery<T> CreateSpecificationQuery<T>(Expression<Func<T, bool>> expression) where T : class
    {
