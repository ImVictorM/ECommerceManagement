...
public static class CreateShippingMethodCommandUtils
{
    ...
    /// <summary>
    /// Creates a new instance of the <see cref="CreateShippingMethodCommand"/> class.
    /// </summary>
    ...
    /// <returns>A new instance of the <see cref="CreateShippingMethodCommand"/> class.</returns>
