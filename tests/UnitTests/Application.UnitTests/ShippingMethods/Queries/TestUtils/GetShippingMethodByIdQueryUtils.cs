...
{
    /// <summary>
    /// Creates a new instance of the <see cref="GetShippingMethodByIdQuery"/> class.
    /// </summary>
    /// <param name="shippingMethodId">The shipping method id.</param>
    /// <returns>A new instance of the <see cref="GetShippingMethodByIdQuery"/> class.</returns>
