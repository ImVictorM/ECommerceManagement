...
using static Application.UnitTests.Common.Behaviors.TestUtils.ValidationBehaviorUtils;
...
/// <summary>
/// Unit tests for the <see cref="ValidationBehavior{TRequest, TResponse}"/> pipeline behavior.
/// </summary>
public class ValidationBehaviorTests
{
    ...
    public ValidationBehaviorTests()
    {
        ...
        var mockLogger = new Mock<ILogger<ValidationBehavior<TestRequest, TestResponse>>>();
    ...
    /// </summary>
    [Fact]
    public async Task HandleValidation_WithValidRequest_ProceedsToNextDelegate()
    {
    ...
    /// </summary>
    [Fact]
    public async Task HandleValidation_WithInvalidRequest_ThrowsException()
    {
        ...
        await FluentActions
            .Invoking(() => _behavior.Handle(request, _mockNextDelegate.Object, default))
            .Should()
    ...
    /// </summary>
    [Fact]
    public async Task HandleValidation_WithoutValidator_ProceedsToNextDelegate()
    {
        ...
        var behaviorWithoutValidator = new ValidationBehavior<TestRequest, TestResponse>(
            mockLogger.Object
        );
        ...
        var response = await behaviorWithoutValidator.Handle(request, _mockNextDelegate.Object, default);
