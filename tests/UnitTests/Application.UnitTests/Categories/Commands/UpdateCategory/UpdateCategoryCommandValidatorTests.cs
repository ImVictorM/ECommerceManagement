...
public class UpdateCategoryCommandValidatorTests
{
    ...
    /// <summary>
    /// Initiates a new instance of the <see cref="UpdateCategoryCommandValidatorTests"/> class.
    /// </summary>
    ...
    public void ValidateUpdateCategoryCommand_WithInvalidName_ShouldHaveValidationError(string invalidName)
    {
