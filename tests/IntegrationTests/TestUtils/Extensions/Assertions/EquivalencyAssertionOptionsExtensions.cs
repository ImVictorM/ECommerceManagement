...
public static class EquivalencyAssertionOptionsExtensions
{
    ...
    /// </summary>
    /// <typeparam name="T">The object that contains DateTimeOffset properties that are comparable.</typeparam>
    /// <param name="options">The current options.</param>
    /// <returns>The options.</returns>
    public static EquivalencyAssertionOptions<T> ComparingWithDateTimeOffset<T>(this EquivalencyAssertionOptions<T> options)
    {
        options
