...
/// </summary>
public sealed class ProductSeed : DataSeed<ProductSeedType, Product>
{
    /// <inheritdoc/>
    ...
    public ProductSeed(IDataSeed<CategorySeedType, Category> categorySeed) : base(CreateSeedData(categorySeed))
    {
        Order = categorySeed.Order + 20;
    }

    private static Dictionary<ProductSeedType, Product> CreateSeedData(IDataSeed<CategorySeedType, Category> categorySeed)
    {
        return new Dictionary<ProductSeedType, Product>()
        {
            [ProductSeedType.COMPUTER_ON_SALE] = ProductUtils.CreateProduct(
                ...
                categories: [
                    ProductCategory.Create(categorySeed.GetByType(CategorySeedType.TECHNOLOGY).Id),
                    ProductCategory.Create(categorySeed.GetByType(CategorySeedType.OFFICE_SUPPLIES).Id)
                ],
                images: [
            ...
            [ProductSeedType.TSHIRT] = ProductUtils.CreateProduct(
                ...
                categories: [
                    ProductCategory.Create(categorySeed.GetByType(CategorySeedType.FASHION).Id),
                    ProductCategory.Create(categorySeed.GetByType(CategorySeedType.SPORTS).Id)
                ],
                images: [
            ...
            [ProductSeedType.CHAIN_BRACELET] = ProductUtils.CreateProduct(
                ...
                categories: [
                    ProductCategory.Create(categorySeed.GetByType(CategorySeedType.JEWELRY).Id),
                    ProductCategory.Create(categorySeed.GetByType(CategorySeedType.FASHION).Id)
                ],
                images: [
            ...
            [ProductSeedType.PENCIL] = ProductUtils.CreateProduct(
                ...
                categories: [
                    ProductCategory.Create(categorySeed.GetByType(CategorySeedType.BOOKS_STATIONERY).Id),
                ],
                images: [
    ...
    public IReadOnlyList<Product> GetSeedProductsByCategories(params CategoryId[] categoryIds)
    {
        return ListAll()
            .Where(p =>
                p.ProductCategories
