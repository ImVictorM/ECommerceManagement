...
public class AdvancePendingShipmentStatusException : BaseException
{
    ...
    private const string DefaultMessage =
        "The shipment cannot be advanced from the pending status. " +
    ...
    internal AdvancePendingShipmentStatusException()
        : base(DefaultMessage, DefaultTitle, _defaultErrorCode)
    {
    }

    internal AdvancePendingShipmentStatusException(string message)
