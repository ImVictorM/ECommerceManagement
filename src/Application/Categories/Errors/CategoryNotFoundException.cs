...
public class CategoryNotFoundException : BaseException
{
    ...
    internal CategoryNotFoundException() : base(DefaultMessage, DefaultTitle, _defaultErrorCode)
    {
    }

    internal CategoryNotFoundException(string message) : base(message, DefaultTitle, _defaultErrorCode)
    {
    }

    internal CategoryNotFoundException(string message, Exception innerException) : base(message, DefaultTitle, _defaultErrorCode, innerException)
    {
    }
}
