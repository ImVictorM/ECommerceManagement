...
public class ShippingMethodNotFoundException : BaseException
{
    ...
    private const string DefaultMessage = "The shipping method being queried was not found";
    private static readonly ErrorCode _defaultErrorCode = ErrorCode.NotFound;

    internal ShippingMethodNotFoundException() : base(DefaultMessage, DefaultTitle, _defaultErrorCode)
    {
    }

    internal ShippingMethodNotFoundException(string message) : base(message, DefaultTitle, _defaultErrorCode)
    {
    }
