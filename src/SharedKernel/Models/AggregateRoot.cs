...
/// </summary>
/// <typeparam name="TId">
/// The type of the unique identifier for the aggregate root.
/// </typeparam>
public abstract class AggregateRoot<TId> : Entity<TId>
    where TId : notnull
{
    /// <summary>
    /// Initializes a new instance of the <see cref="AggregateRoot{TId}"/>
    /// class with the specified unique identifier
    /// </summary>
    /// <param name="id">
