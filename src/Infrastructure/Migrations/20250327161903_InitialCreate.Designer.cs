...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20250327161903_InitialCreate")]
            ...
            modelBuilder.Entity("Domain.CarrierAggregate.Carrier", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedAt = new DateTimeOffset(new DateTime(2025, 3, 27, 16, 19, 1, 827, DateTimeKind.Unspecified).AddTicks(4457), new TimeSpan(0, 0, 0, 0, 0)),
                            Email = "carrier@email.com",
                            Name = "ECommerceManagementCarrier",
                            PasswordHash = "95BA46FDFD801249ABAF2870495BE71DC2814DA5302EB41A541927DDDE80338C-B406438DF9A1B7279118B9C66A3C0028",
                            Phone = "",
                            UpdatedAt = new DateTimeOffset(new DateTime(2025, 3, 27, 16, 19, 1, 827, DateTimeKind.Unspecified).AddTicks(4462), new TimeSpan(0, 0, 0, 0, 0)),
                            _roleId = 3L
                        });
                });
            ...
            modelBuilder.Entity("Domain.UserAggregate.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedAt = new DateTimeOffset(new DateTime(2025, 3, 27, 16, 19, 1, 812, DateTimeKind.Unspecified).AddTicks(2870), new TimeSpan(0, 0, 0, 0, 0)),
                            Email = "admin@email.com",
                            IsActive = true,
                            Name = "admin",
                            PasswordHash = "6374A40C3749179CDA949178762383C184FE670EE363BAEE90BC1DE507949C2C-48BC4C822BFC71889E9729C63D38F5FA",
                            UpdatedAt = new DateTimeOffset(new DateTime(2025, 3, 27, 16, 19, 1, 812, DateTimeKind.Unspecified).AddTicks(2875), new TimeSpan(0, 0, 0, 0, 0))
                        });
                });
