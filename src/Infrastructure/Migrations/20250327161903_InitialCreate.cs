    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1L, new DateTimeOffset(new DateTime(2025, 3, 27, 16, 19, 1, 812, DateTimeKind.Unspecified).AddTicks(2870), new TimeSpan(0, 0, 0, 0, 0)), "admin@email.com", true, "admin", "6374A40C3749179CDA949178762383C184FE670EE363BAEE90BC1DE507949C2C-48BC4C822BFC71889E9729C63D38F5FA", null, new DateTimeOffset(new DateTime(2025, 3, 27, 16, 19, 1, 812, DateTimeKind.Unspecified).AddTicks(2875), new TimeSpan(0, 0, 0, 0, 0)) });

            migrationBuilder.InsertData(
                table: "carriers",
                columns: new[] { "id", "created_at", "email", "name", "password_hash", "phone", "updated_at", "id_role" },
                values: new object[] { 1L, new DateTimeOffset(new DateTime(2025, 3, 27, 16, 19, 1, 827, DateTimeKind.Unspecified).AddTicks(4457), new TimeSpan(0, 0, 0, 0, 0)), "carrier@email.com", "ECommerceManagementCarrier", "95BA46FDFD801249ABAF2870495BE71DC2814DA5302EB41A541927DDDE80338C-B406438DF9A1B7279118B9C66A3C0028", "", new DateTimeOffset(new DateTime(2025, 3, 27, 16, 19, 1, 827, DateTimeKind.Unspecified).AddTicks(4462), new TimeSpan(0, 0, 0, 0, 0)), 3L });
